...
| `img/hero/WhatsApp Image 2026-09-24 at 14.22.39.jpeg` | supplied by owner (original) | 1280×720 JPG, ~216 KB | Archival source — fresh vegetables photograph (hero slide 1). Kept unmodified |
| `img/hero/WhatsApp Image 2026-09-24 at 14.32.08.jpeg` | supplied by owner (original) | 1280×720 JPG, ~183 KB | Archival source — meat/seafood/poultry photograph (hero slide 2). Kept unmodified |
| `public/img/hero/hero-vegetables.jpeg` | copy of the 14.22.39 source | identical | Homepage hero carousel slide 1 (fresh vegetables) |
| `public/img/hero/hero-meat-seafood.jpeg` | copy of the 14.32.08 source | identical | Homepage hero carousel slide 2 (meat, seafood, poultry and eggs) |
...
- **Hero / photography:** the two owner-supplied photographs (`img/hero/`) are
  now the homepage hero background carousel — cross-fading slides with autoplay,
  Previous/Next controls and indicators, on both the desktop hero (≥768px) and
  the mobile storefront hero (≤767px). Clean copies live at
  `public/img/hero/hero-vegetables.jpeg` and `public/img/hero/hero-meat-seafood.jpeg`;
  the WhatsApp-named originals in `img/hero/` are kept as the archive.
